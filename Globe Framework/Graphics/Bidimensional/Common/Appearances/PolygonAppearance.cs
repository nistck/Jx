...
namespace Globe.Graphics.Bidimensional.Common
{
    ...
    public class PolygonAppearance : Appearance
    {
        ...
        {
            get { return Globe.Core.Converters.ColorConverter.StringFromColor(_backgroundColor1, ';'); }
            set { _backgroundColor1 = Globe.Core.Converters.ColorConverter.ColorFromString(value, ';'); }
        }

        [XmlFieldSerializable("backgroundColor2String")]
        string BackGroundColor2String
        {
            get { return Globe.Core.Converters.ColorConverter.StringFromColor(_backgroundColor2, ';'); }
            set { _backgroundColor2 = Globe.Core.Converters.ColorConverter.ColorFromString(value, ';'); }
        }
