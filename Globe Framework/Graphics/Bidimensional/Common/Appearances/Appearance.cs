...
namespace Globe.Graphics.Bidimensional.Common
{
    ...
    public abstract class Appearance : ICloneable
    {
        ...
        {
            get { return Globe.Core.Converters.ColorConverter.StringFromColor(_activePen.Color, ';'); }
            set { _activePen.Color = Globe.Core.Converters.ColorConverter.ColorFromString(value, ';'); }
        }

        [XmlFieldSerializable("borderColorString")]
        string BorderColorString
        {
            get { return Globe.Core.Converters.ColorConverter.StringFromColor(_borderColor, ';'); }
            set { _borderColor = Globe.Core.Converters.ColorConverter.ColorFromString(value, ';'); }
        }

        [XmlFieldSerializable("markerColorString")]
        string MarkerColorString
        {
            get { return Globe.Core.Converters.ColorConverter.StringFromColor(_markerColor, ';'); }
            set { _markerColor = Globe.Core.Converters.ColorConverter.ColorFromString(value, ';'); }
        }
        ...
        virtual protected void DrawSelection(IDocument document, PaintEventArgs e)
        {
            ...
            if (Globe.Graphics.Bidimensional.Common.Select.LastSelectedShape == _shape)
