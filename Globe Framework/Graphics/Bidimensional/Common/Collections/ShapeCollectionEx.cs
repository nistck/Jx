...
namespace Globe.Graphics.Bidimensional.Common
{
    ...
    public class ShapeCollectionEx : ShapeCollection
    {
        ...
        /// </summary>
        virtual public event Globe.Graphics.Bidimensional.Common.TranslateHandler ShapeTranslateOccurred;

        /// <summary>
        /// Notifies scale movement.
        /// </summary>
        virtual public event Globe.Graphics.Bidimensional.Common.ScaleHandler ShapeScaleOccurred;

        /// <summary>
        /// Notifies rotate movement.
        /// </summary>
        virtual public event Globe.Graphics.Bidimensional.Common.RotateHandler ShapeRotateOccurred;

        /// <summary>
        /// Notifies deform movement.
        /// </summary>
        virtual public event Globe.Graphics.Bidimensional.Common.DeformHandler ShapeDeformOccurred;

        /// <summary>
        /// Notifies mirror horizontal movement.
        /// </summary>
        virtual public event Globe.Graphics.Bidimensional.Common.MirrorHorizontalHandler ShapeMirrorHorizontalOccurred;

        /// <summary>
        /// Notifies mirror vertical movement.
        /// </summary>
        virtual public event Globe.Graphics.Bidimensional.Common.MirrorVerticalHandler ShapeMirrorVerticalOccurred;
