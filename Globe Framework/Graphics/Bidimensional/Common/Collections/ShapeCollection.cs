...
namespace Globe.Graphics.Bidimensional.Common
{
    ...
    public class ShapeCollection : Collection<IShape>, ICollection, ICloneable
    {
        ...
        /// </summary>
        virtual public event Globe.Graphics.Bidimensional.Common.MovementHandler ShapeMovementOccurred;

        /// <summary>
        /// Notifies anyone appearance changing.
        /// </summary>
        virtual public event Globe.Graphics.Bidimensional.Common.AppearanceHandler ShapeAppearanceChanged;
        ...
        protected override void InsertItem(int index, IShape item)
        {
            ...
            item.ShapeChanged += new Globe.Graphics.Bidimensional.Common.ShapeChangingHandler(item_ShapeChanged);
