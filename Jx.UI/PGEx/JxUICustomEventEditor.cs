...
{
	public class JxUICustomEventEditor : UITypeEditor
	{				
		public delegate object OnClick(object sender, EventArgs e);
		protected OnClick m_MethodDelegate;
		protected JxCustomProperty.CustomPropertyDescriptor m_sender;
        ...
        public override object EditValue(ITypeDescriptorContext context, System.IServiceProvider provider, object value)
		{
			...
			if (m_sender == null)
			{
				m_sender = context.PropertyDescriptor as JxCustomProperty.CustomPropertyDescriptor;
			}
        ...
        public class DelegateAttribute : Attribute
		{
			...
			protected JxUICustomEventEditor.OnClick m_MethodDelegate;
			
			public JxUICustomEventEditor.OnClick GetMethod
			{
				get
				{
			...
			public DelegateAttribute(JxUICustomEventEditor.OnClick MethodDelegate)
			{
