...
{
    partial class JxTabControl
    {
        internal partial class CaptionColorChooser : Form
        {
            #region Instance Members

            public JxTabControl contextInstance;
            ...
            {
                Randomizer = new JxTabControl.RandomizerCaption((byte)nmrRed.Value, (byte)nmrGreen.Value, (byte)nmrBlue.Value, (byte)nmrAlpha.Value,
