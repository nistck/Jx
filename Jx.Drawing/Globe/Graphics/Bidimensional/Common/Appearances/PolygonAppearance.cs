...
namespace Jx.Graphics.Bidimensional.Common
{
    ...
    public class PolygonAppearance : Appearance
    {
        ...
        {
            get { return Jx.Core.Converters.ColorConverter.StringFromColor(_backgroundColor1, ';'); }
            set { _backgroundColor1 = Jx.Core.Converters.ColorConverter.ColorFromString(value, ';'); }
        }

        [XmlFieldSerializable("backgroundColor2String")]
        string BackGroundColor2String
        {
            get { return Jx.Core.Converters.ColorConverter.StringFromColor(_backgroundColor2, ';'); }
            set { _backgroundColor2 = Jx.Core.Converters.ColorConverter.ColorFromString(value, ';'); }
        }
