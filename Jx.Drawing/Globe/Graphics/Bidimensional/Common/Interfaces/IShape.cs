...
namespace Jx.Graphics.Bidimensional.Common
{
    ...
    public interface IShape : ICloneable, IActions
    {
        ...
        /// </summary>
        event Jx.Graphics.Bidimensional.Common.ShapeChangingHandler ShapeChanged;

        /// <summary>
        /// Fires when mouse down on shape.
        /// </summary>
        event Jx.Graphics.Bidimensional.Common.MouseDownOnShape ShapeMouseDown;

        /// <summary>
        /// Fires when mouse up on shape.
        /// </summary>
        event Jx.Graphics.Bidimensional.Common.MouseUpOnShape ShapeMouseUp;

        /// <summary>
        /// Fires when mouse click on shape.
        /// </summary>
        event Jx.Graphics.Bidimensional.Common.MouseClickOnShape ShapeMouseClick;

        /// <summary>
        /// Fires when mouse double click on shape.
        /// </summary>
        event Jx.Graphics.Bidimensional.Common.MouseDoubleClickOnShape ShapeMouseDoubleClick;

        /// <summary>
        /// Fires when mouse move on shape.
        /// </summary>
        event Jx.Graphics.Bidimensional.Common.MouseMoveOnShape ShapeMouseMove;

        /// <summary>
        /// Fires when mouse wheel on shape.
        /// </summary>
        event Jx.Graphics.Bidimensional.Common.MouseWheel ShapeMouseWheel;

        /// <summary>
        /// Fires when paint shape.
        /// </summary>
        event Jx.Graphics.Bidimensional.Common.PaintOnShape ShapePaint;
