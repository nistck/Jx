...
namespace Jx.Graphics.Bidimensional.Common
{
    ...
    public class ShapeCollection : Collection<IShape>, ICollection, ICloneable
    {
        ...
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.MovementHandler ShapeMovementOccurred;

        /// <summary>
        /// Notifies anyone appearance changing.
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.AppearanceHandler ShapeAppearanceChanged;
        ...
        protected override void InsertItem(int index, IShape item)
        {
            ...
            item.ShapeChanged += new Jx.Graphics.Bidimensional.Common.ShapeChangingHandler(item_ShapeChanged);
