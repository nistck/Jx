...
namespace Jx.Graphics.Bidimensional.Common
{
    ...
    public abstract class Shape : IShape
    {
        ...
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.ShapeChangingHandler ShapeChanged;

        /// <summary>
        /// Fires when mouse down on shape.
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.MouseDownOnShape ShapeMouseDown;

        /// <summary>
        /// Fires when mouse up on shape.
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.MouseUpOnShape ShapeMouseUp;

        /// <summary>
        /// Fires when mouse click on shape.
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.MouseClickOnShape ShapeMouseClick;

        /// <summary>
        /// Fires when mouse double click on shape.
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.MouseDoubleClickOnShape ShapeMouseDoubleClick;

        /// <summary>
        /// Fires when mouse move on shape.
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.MouseMoveOnShape ShapeMouseMove;

        /// <summary>
        /// Fires when mouse wheel on shape.
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.MouseWheel ShapeMouseWheel;

        /// <summary>
        /// Fires when paint shape
        /// </summary>
        virtual public event Jx.Graphics.Bidimensional.Common.PaintOnShape ShapePaint;
        ...
        Jx.Graphics.Bidimensional.Common.Appearance _appearance = new PolygonAppearance();
        /// <summary>
        /// Gets or sets the appearance.
        /// </summary>
        [XmlFieldSerializable("Appearance"), System.ComponentModel.TypeConverter(typeof(AppearanceTypeConverter))]
        public Jx.Graphics.Bidimensional.Common.Appearance Appearance
        {
