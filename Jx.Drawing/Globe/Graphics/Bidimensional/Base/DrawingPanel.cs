...
namespace Jx.Graphics.Bidimensional.Base
{
    ...
    public class DrawingPanel : Panel, IDocument
    {
        ...
        public DrawingPanel()
        {
            ...
            _shapes.ShapeChanged += new Jx.Graphics.Bidimensional.Common.ShapeChangingHandler(_shapes_ShapeChanged);
...
//                this.Size = new Size((int)_zoom * this.Size.Width, (int)_zoom * this.Size.Height);
        ...
        virtual public void Cut()
        {
            ...
            Clipboard<ShapeCollection>.Clip = Jx.Graphics.Bidimensional.Common.Select.GetSelectedShapes(_shapes);
        ...
        {
            if (Jx.Graphics.Bidimensional.Common.Select.LastSelectedShape == null)
            ...
            if (System.Windows.Forms.Control.ModifierKeys == Keys.Control)
                selectedShapes.AddRange(Jx.Graphics.Bidimensional.Common.Select.GetSelectedShapes(_shapes));
            else
                selectedShapes.Add(Jx.Graphics.Bidimensional.Common.Select.LastSelectedShape);
        ...
        void _shapes_ShapeAppearanceChanged(Jx.Graphics.Bidimensional.Common.Appearance appearance)
        {
            History<ShapeCollection>.Memorize(_shapes);
