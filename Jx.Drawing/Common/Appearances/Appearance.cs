...
namespace Jx.Drawing.Common
{
    ...
    public abstract class Appearance : ICloneable
    {
        ...
        {
            get { return Jx.Drawing.Converters.ColorConverter.StringFromColor(_activePen.Color, ';'); }
            set { _activePen.Color = Jx.Drawing.Converters.ColorConverter.ColorFromString(value, ';'); }
        }

        [XmlFieldSerializable("borderColorString")]
        string BorderColorString
        {
            get { return Jx.Drawing.Converters.ColorConverter.StringFromColor(_borderColor, ';'); }
            set { _borderColor = Jx.Drawing.Converters.ColorConverter.ColorFromString(value, ';'); }
        }

        [XmlFieldSerializable("markerColorString")]
        string MarkerColorString
        {
            get { return Jx.Drawing.Converters.ColorConverter.StringFromColor(_markerColor, ';'); }
            set { _markerColor = Jx.Drawing.Converters.ColorConverter.ColorFromString(value, ';'); }
        }
