...
namespace Jx.Drawing.Common
{
    ...
    public class ShapeCollectionEx : ShapeCollection
    {
        ...
        /// </summary>
        virtual public event Jx.Drawing.Common.TranslateHandler ShapeTranslateOccurred;

        /// <summary>
        /// Notifies scale movement.
        /// </summary>
        virtual public event Jx.Drawing.Common.ScaleHandler ShapeScaleOccurred;

        /// <summary>
        /// Notifies rotate movement.
        /// </summary>
        virtual public event Jx.Drawing.Common.RotateHandler ShapeRotateOccurred;

        /// <summary>
        /// Notifies deform movement.
        /// </summary>
        virtual public event Jx.Drawing.Common.DeformHandler ShapeDeformOccurred;

        /// <summary>
        /// Notifies mirror horizontal movement.
        /// </summary>
        virtual public event Jx.Drawing.Common.MirrorHorizontalHandler ShapeMirrorHorizontalOccurred;

        /// <summary>
        /// Notifies mirror vertical movement.
        /// </summary>
        virtual public event Jx.Drawing.Common.MirrorVerticalHandler ShapeMirrorVerticalOccurred;
