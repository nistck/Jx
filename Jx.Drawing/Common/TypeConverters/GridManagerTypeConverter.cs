...
{
    /// <summary>
    /// Visualizes the GridManager object in a PropertyGrid control.
    /// </summary>
    public class GridManagerTypeConverter : ExpandableObjectConverter
    {
        ...
        {
            if (destinationType == typeof(GridManager))
                return true;
        ...
        {
            if (destinationType == typeof(System.String) && value is GridManager)
            {
                GridManager gridManager = (GridManager)value;

                return Jx.Drawing.Properties.Resources.GridManager;
            }
