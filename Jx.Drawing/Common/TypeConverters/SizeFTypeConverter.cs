...
{
    /// <summary>
    /// Visualizes the SizeF value in a PropertyGrid control.
    /// </summary>
    public class SizeFTypeConverter : ExpandableObjectConverter
    {
        ...
        {
            if (destinationType == typeof(System.Drawing.SizeF))
                return true;
        ...
        {
            if (destinationType == typeof(System.String) && value is System.Drawing.SizeF)
            {
        ...
        public override object CreateInstance(ITypeDescriptorContext context, System.Collections.IDictionary propertyValues)
        {
            if (propertyValues != null)
                return new System.Drawing.SizeF((float)propertyValues["Width"], (float)propertyValues["Height"]);
